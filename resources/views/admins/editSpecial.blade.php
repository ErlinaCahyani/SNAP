...
<div class="container">
 ...
 @endif
 {!! Form::model($admin, ['method' => 'PATCH','route' => ['managespecials.update', $admin->id]]) !!}
 <div class="row">
 ...
 {!! Form::text('desc', null, array('placeholder' => 'Description','class' => 'formcontrol'))
!!}
 </div>
 </div>

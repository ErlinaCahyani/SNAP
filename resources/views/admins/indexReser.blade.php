...
<nav class="navbar navbar-light">
  <ul>
      ...
      <li>
          <a class="navbar-brand biru" href="{{ route('manageresers.index') }}">Reservations</a>
      </li>
      <li>
...
href="{{ route('manageresers.show',$admin->id) }}">Detail</a>
<a class="btn btn-primary"
href="{{ route('manageresers.edit',$admin->id) }}">Edit</a>
{!! Form::open(['method' => 'DELETE','route' =>
['manageresers.destroy', $admin->id],'style'=>'display:inline']) !!}
